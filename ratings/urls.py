...
urlpatterns = [
    path('review/create/<int:service_request_id>/', views.create_request_review, name='create_review'),
    path('review/edit/<int:review_id>/', views.edit_review, name='edit_review'),
    path('provider/<int:provider_id>/reviews/', views.provider_reviews, name='provider_reviews'),
    path('direct-request/<int:direct_request_id>/review/', views.create_direct_request_review, name='create_direct_service_request_review'),
