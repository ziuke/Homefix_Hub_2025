    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('tenant', 'Tenant'), ('serviceprovider', 'Service Provider'), ('admin', 'Admin')], max_length=15)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('phone_number', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(message='Phone number must start with 6,7,8, or 9 and be exactly 10 digits long.', regex='^[6-9]\\d{9}$')])),
